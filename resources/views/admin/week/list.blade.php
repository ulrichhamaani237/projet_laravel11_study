        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center flex-wrap">
                    <h4 class="card-title">Weeks List</h4>
                    <div class="d-flex  align-items-center">
                          ...
                          @foreach ($getRecord as $value) 
                                ...
                                <tr class="table-info text-dark">
                                    ...
                                    <td>
                                        ...
                                        <a class="dropdown-item d-flex align-items-center" href="{{ url('admin/week/edit/'.$value->id) }}">
                                        ...
                                        <a class="dropdown-item d-flex align-items-center" href="{{ url('admin/week/delete/'.$value->id) }}"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-trash icon-sm me-2">
