                            ...
                            <form class="a_form{{ $value->id }}" method="post">
                                ...
                                <tr class="table-info text-dark">
                                    ...
                                    <td style="min-width: 150px">
                                        <input type="hidden" class="form-control" value="{{ $value->id }}" name="edit_id">
                                        <input type="text" class="form-control" value="{{ old('name',$value->name) }}" name="edit_name" id="">
                                        <br>
                                        <button type="button" class="btn btn-success submitfform " id="{{ $value->id }}">Save</button>
                                    </td>
