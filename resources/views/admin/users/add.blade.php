            ...
            <div class="card-body">
                ...
                <form method="POST" action="" class="forms-sample">
                   @csrf
                    ...
                    <div class="row mb-3">
                        <label for="exampleInputUsername2" class="col-sm-3 col-form-label">Name<span style="color: red">*</span></label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="exampleInputUsername2" name="name" placeholder="name">
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <input type="email" class="form-control" id="exampleInputEmail2" autocomplete="off" name="email" placeholder="Email">
                        </div>
                    </div>
